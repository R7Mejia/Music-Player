...
<head>
    ...
    <title>R-Mejia Music Player</title>
...
<body>
    <div class="header">
        <p class="header-text">This app is intended for those moments like while going on a plane when you want to
            listen to music without interruptions, and/or where internet connectivity is limited.</p>
    </div>
    <div class="container">
        ...
        <div class="player">
            ...
            <div class="player-content">
                <div id="player-album-art">
                    <img src="./images/WOLF.png" alt="song cover art" />
                </div>
                <div class="player-display">
                    ...
                    <div class="player-buttons">
                        ...
                        <button id="play-pause" class="play-pause" aria-label="Play/Pause">
                        ...
                        <button id="background-btn" class="background-btn" aria-label="Change Background">
        ...
        <div class="content-section">
            <div class="tab-navigation">
                <button class="tab-btn active" data-tab="playlist-tab">Playlist</button>
                <button class="tab-btn" data-tab="upload-tab">Upload Music</button>
                <button class="tab-btn" data-tab="video-tab">Videos</button>
            </div>

            <!-- Playlist Tab -->
            <div id="playlist-tab" class="tab-content active">
                <div class="playlist">
                    <div class="playlist-bar">
                        ...
                        <h2 class="playlist-title">Lista de canciones</h2>
                        <div class="parallel-lines">
                            <div></div>
                            <div></div>
                        </div>
                ...
                <div class="upload-section">
                    ...
                    <div class="upload-area">
                        <div class="upload-box">
                            ...
                            <button class="upload-btn" onclick="document.getElementById('music-file-input').click()">
                                Choose Audio Files
                            </button>
                        </div>
                    </div>
                    <div class="supported-formats">
                        <p><strong>Supported formats:</strong> MP3, WAV, OGG, M4A, FLAC</p>
                    </div>
                </div>
            </div>
            ...
            <div id="video-tab" class="tab-content">
                <div class="video-section">
                    <div class="video-header">
                        <h2>Video Player</h2>
                        <p>Upload videos or add from URL</p>
                    </div>
                    ...
                    <div class="video-upload-area">
                        <div class="upload-methods">
                            <div class="upload-method">
                                ...
                                <div class="upload-box">
                                    <div class="upload-icon">🎬</div>
                                    <p>Select video files from your device</p>
                            ...
                            <div class="upload-method">
                                ...
                                <div class="url-input-container">
                                    <input type="url" id="video-url-input"
                                        placeholder="Enter video URL (YouTube, Vimeo, etc.)" class="url-input">
                                    <button id="add-video-url-btn" class="add-url-btn">Add Video</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="video-modal" class="video-modal">
        <div class="video-modal-content">
            <div class="video-header">
                ...
                <button id="close-video-btn" class="close-video-btn">&times;</button>
            </div>
    ...
    <!-- Background Modal -->
    <div id="background-modal" class="background-modal">
        <div class="background-modal-content">
            <div class="background-modal-header">
                <h3>Choose Background</h3>
                <button id="close-background-modal" class="close-background-btn">&times;</button>
            </div>
            
            <div class="background-upload-section">
                <div class="background-upload-methods">
                    <div class="background-upload-method">
                        <h4>Upload Image</h4>
